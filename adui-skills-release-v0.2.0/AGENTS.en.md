...
Run `npm run release:check -- --tag vX.Y.Z` before publishing. Tags are created manually from merged `main` commits. Public releases require a real Folder Hash lock baseline. Chinese release notes are canonical with `.en.md` fallbacks.
